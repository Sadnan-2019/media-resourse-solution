...
const News = () => {
  return (
    <div>
      <h2 class="mb-12 text-center mt-9 text-3xl font-bold">Our Conserns</h2>
          ...
          <section class="mb-32 text-center md:text-left">
            ...
            <div class="mb-6 flex flex-wrap">
              ...
              <div class="mb-6 mr-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-9/12 xl:w-7/12">
                <h5 class="mb-3 text-lg font-bold">Welcome to HealthCare At Home</h5>
            ...
            <div class="mb-6 flex flex-wrap">
              ...
              <div class="mb-6 mr-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-9/12 xl:w-7/12">
                <h5 class="mb-3 text-lg font-bold">Welcome to LEAP</h5>
            ...
            <div class="mb-6 flex flex-wrap">
              ...
              <div class="mb-6 mr-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-9/12 xl:w-7/12">
                <h5 class="mb-3 text-lg font-bold">Welcome to Rose Beauty Garden</h5>
                <div class="mb-3 gap-2 flex items-center justify-center text-sm font-medium text-yellow-600 md:justify-start">
        ...
        <div class="container   mx-auto md:px-6">
          ...
          <section class="mb-32 text-center md:text-left">
            ...
            <div class="mb-6 flex flex-wrap">
              ...
              <div class="mb-6 mr-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-9/12 xl:w-7/12">
                <h5 class="mb-3 text-lg font-bold">Welcome to MRG</h5>
            ...
            <div class="mb-6 flex flex-wrap">
              ...
              <div class="mb-6 mr-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-9/12 xl:w-7/12">
                <h5 class="mb-3 text-lg font-bold">Welcome to Trishal Medical Center</h5>
            ...
            <div class="mb-6 flex flex-wrap">
              ...
              <div class="mb-6 mr-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-9/12 xl:w-7/12">
                <h5 class="mb-3 text-lg font-bold">Welcome to Trishal Convention Center</h5>
